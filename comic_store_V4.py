...
pickle.dumps(my_inventory)
pickle.loads(my_inventory)
...
def generate_comic_inventory():
    for comic in comic_list:
        inventory[comic.comic_name] = comic.comic_name, comic.num_of_copies
...
def load_inventory(filename):
    try:
        ...
        generate_comic_inventory()
        return inventory


# List of comics that are being sold
comic_list: list[Comic] = [
    Comic("Super Dude", 8, "Best seller", 0),
...
inventory = load_inventory("comic_store_inventory.txt")
